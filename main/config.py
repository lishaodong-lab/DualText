...
##################### Text_Guidance#####################
        ...
        lambda_TAI_inst = 1e3
        lambda_TAI_joints = 1
        lambda_TAI_pixel = 1e2
        h_num_keypoints = 21
        TAI_prior_prob = 0.01
        h_dim_reduction = True
        h_global_text_channels = 512
        h_focal_text_channels = 768
        h_inter_channels = 128
        joints_text_channels = 768

        TAI_inter_channels = 256
