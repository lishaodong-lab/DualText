...
class ViT(nn.Module):
    def __init__(self, *, image_size, patch_size, dim, heads, mlp_dim, channels=32, dim_head=64, dropout=0.,
                 emb_dropout=0.):
        ...
        self.transformer = Transformer_h(dim, heads, dim_head, mlp_dim, dropout)
